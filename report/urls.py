...
urlpatterns = [
    ...
    path('report/audit_shares', views.AuditSharesView.as_view(), name='audit_shares'),
    # Utils
    ...
    path('utils/fairvaluecontrol/', views.FairValueControlView.as_view(), name='fair_value_control'),
]
