...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('base_info', '0002_historicalsharetype_historicalsector_and_more'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('amount', models.IntegerField()),
                ('complite', models.BooleanField(default=True)),
                ('add_datetime', models.DateTimeField(blank=True, editable=False)),
                ('last_edit_datetime', models.DateTimeField(blank=True, editable=False)),
                ('comment', models.TextField(blank=True, max_length=1024)),
                ('history_id', models.AutoField(primary_key=True, serialize=False)),
                ('history_date', models.DateTimeField(db_index=True)),
                ('history_change_reason', models.CharField(max_length=100, null=True)),
                ...
                ('history_user', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='+', to=settings.AUTH_USER_MODEL)),
                ('last_edit_by', models.ForeignKey(blank=True, db_constraint=False, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to=settings.AUTH_USER_MODEL)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.ForeignKey(blank=True, db_constraint=False, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to='home.companystatus')),
            ],
            options={
